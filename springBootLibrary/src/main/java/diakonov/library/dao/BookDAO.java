...
public class BookDAO {
    ...
    public void save(Book book) {
        jdbcTemplate.update("INSERT INTO Book(bookName, author, yearOfIssue) VALUES(?, ?, ?)", book.getBookName(), book.getAuthor(), book.getYearOfIssue());
    }

    public void update(int id, Book updatedBook) {
        jdbcTemplate.update("UPDATE Book SET bookName=?, author=?, yearOfIssue=? WHERE id=?", updatedBook.getBookName(), updatedBook.getAuthor(), updatedBook.getYearOfIssue(), id);
    }
    ...
    public void addReaderForBook(int bookId, Person person){
    ...
    public Optional<Person> findBookReader(int id){
